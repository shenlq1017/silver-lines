...
电影质感的银幕金句策展站 · **Phase C4（金句 349 · Top249 + Classics×100）**。
...
| 项 | 说明 |
|----|------|
| 数据 | `data/quotes.json` **349** 条 `status=published`（Top249 + Classics C1×25 + C2×25 + C3×25 + C4×25） |
| 片名 | Top249 对齐豆瓣 Top250 意图截取（名次 1–250 除 108 茶馆；冻结日 2026-09-25）；另含 Classics C1+C2+C3+C4 batch-jia 影史经典共 100 部（见 `data/source.json` → `c1` / `c2` / `c3` / `c4`） |
...
│   └── source.json          # 来源 / 冻结日 / Top249 名单 / Classics C1+C2+C3+C4
├── assets/
│   ├── css/style.css
│   ├── js/ratings.js
│   ├── js/site.js
