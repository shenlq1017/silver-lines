...
电影质感的银幕金句策展站 · **Phase M6（Top100 上架）**。
...
| 项 | 说明 |
|----|------|
| 数据 | `data/quotes.json` 恰好 **100** 条 `status=published` |
| 片名 | 对齐豆瓣 Top250 意图截取 Top100（冻结日 2026-09-25，见 `data/source.json`） |
