...
电影质感的银幕金句策展站 · **Phase C1（金句 274 · Top249 + Classics×25）**。
...
| 项 | 说明 |
|----|------|
| 数据 | `data/quotes.json` **274** 条 `status=published`（Top249 + Classics C1×25） |
| 片名 | Top249 对齐豆瓣 Top250 意图截取（名次 1–250 除 108 茶馆；冻结日 2026-09-25）；另含 Classics C1 batch-jia 影史经典 25 部（见 `data/source.json` → `c1`） |
...
│   └── source.json          # 来源 / 冻结日 / Top249 名单 / Classics C1
├── assets/
│   ├── css/style.css
│   ├── js/ratings.js
│   ├── js/site.js
