...
电影质感的银幕金句策展站 · **Phase M12（Top247 上架）**。
...
| 项 | 说明 |
|----|------|
| 数据 | `data/quotes.json` 恰好 **247** 条 `status=published` |
| 片名 | 对齐豆瓣 Top250 意图截取 Top247（名次 1–250 除 108/141/142；冻结日 2026-09-25，见 `data/source.json`） |
